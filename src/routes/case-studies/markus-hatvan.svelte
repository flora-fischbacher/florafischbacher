    ...
    <div class="grid grid-cols-12 gap-6">
      ...
      <div class="col-span-12 lg:col-span-4">
        <div class="card">
          ...
          <h3 class="tagline">Project Objective</h3>
          <p>The following goals for the project were set:</p>
          <ul>
            <li>Logo design</li>
            <li>Design the mockups of the website</li>
            <li>Design the UX/UI of the technical blog</li>
          </ul>
        </div>
      </div>
      <div class="col-span-12 lg:col-span-4">
